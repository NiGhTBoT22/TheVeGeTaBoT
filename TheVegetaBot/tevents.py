...
from TheVegetaBot import MONGO_DB_URI
from TheVegetaBot import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import TheVegetaBot.tevents

        path = Path(f"TheVegetaBot/modules/{shortname}.py")
        name = "TheVegetaBot.modules.{}".format(shortname)
