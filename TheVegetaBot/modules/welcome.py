...
import TheVegetaBot .modules.sql.welcome_sql as sql
from TheVegetaBot  import (DEV_USERS, LOGGER, OWNER_ID, DRAGONS, DEMONS, TIGERS,
                          WOLVES, sw, dispatcher, JOIN_LOGGER)
from TheVegetaBot .modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from TheVegetaBot .modules.helper_funcs.misc import build_keyboard, revert_buttons
from TheVegetaBot .modules.helper_funcs.msg_types import get_welcome_type
from TheVegetaBot .modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from TheVegetaBot .modules.log_channel import loggable
from TheVegetaBot .modules.sql.global_bans_sql import is_user_gbanned
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Oh, Genos? The Super Saiyan Prince 𝓥𝓮𝓖𝓮𝓣𝓪 just joined🔹!",
                    reply_to_message_id=reply)
...
def left_member(update: Update, context: CallbackContext):
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            # Give the Sudos a special goodbye
            elif left_mem.id in DRAGONS:
                update.effective_message.reply_text(
                    "See you later at the DRAGON'S•ASSOCIATION !",
                    reply_to_message_id=reply,
                )
            ...
            # Give the Support a special goodbye
            elif left_mem.id in DEMONS:
                update.effective_message.reply_text(
                    "See you later at the DRAGON'S•ASSOCIATION !",
                    reply_to_message_id=reply,
                )
